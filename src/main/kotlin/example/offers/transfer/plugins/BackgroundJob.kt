...
class BackgroundJob(configuration: JobConfiguration) : Closeable {
    ...
    object BackgroundJobConsumerPaging : BaseApplicationPlugin<Application, JobConfiguration, BackgroundJob> {
        override val key: AttributeKey<BackgroundJob> = AttributeKey("PagingJob")
